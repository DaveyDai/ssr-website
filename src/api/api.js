// 接口地址配置文件
const apiBaseUrl = process.env.NODE_ENV === 'development' || process.env.NODE_TEST === 'TESTBASE' ? '' : '/vava-pc-gateway'
const uploadBaseUrl = process.env.NODE_ENV === 'development' || process.env.NODE_TEST === 'TESTBASE' ? '' : '/vava-file-gateway'
export default {
  // 公共接口
