<template>
  <div class="forgot-password">
    ...
    <vava-input v-show="!verificationShow" v-model="sendCodeParam.sendToEmail" class="forgot-password-input" placeholder="Email Address"></vava-input>
    <!-- 邮箱验证码输入框 -->
    ...
    <vava-button v-if="!verificationShow" @click="sendCode">SEND CODE</vava-button>
